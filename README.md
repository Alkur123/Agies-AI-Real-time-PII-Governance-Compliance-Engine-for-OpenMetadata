...
<img src="Docs/agies _AI.png" alt="Agies AI Logo" width="360"/>
...
<table>
  <tr>
    <td align="center"><img src="Docs/PII-BLOCK.jpeg" alt="PII Block Decision" width="400"/><br/><sub><b>Real-time PII Query Block</b></sub></td>
    <td align="center"><img src="Docs/Safe-query.jpeg" alt="Safe Query Allow" width="400"/><br/><sub><b>Safe Query — Allowed</b></sub></td>
  </tr>
  <tr>
    <td align="center"><img src="Docs/Data-catalog.png" alt="Data Catalog Scan" width="400"/><br/><sub><b>Catalog Scan — Risk Levels</b></sub></td>
    <td align="center"><img src="Docs/compailence-report.png" alt="Compliance Report" width="400"/><br/><sub><b>Board-Ready Compliance Report</b></sub></td>
  </tr>
</table>
...
> 🗺️ **[Docs/ARCHITECTURE.md](Docs/ARCHITECTURE.md)** — *How do you fit FAISS, ONNX, Redis, MongoDB Atlas, CloudFront, and OpenMetadata into one coherent system without it falling apart? This doc is the answer — every layer, every decision, every tradeoff drawn out.*

> 🧩 **[Docs/DESIGN.md](Docs/DESIGN.md)** — *Why 11 rings? Why FAISS over a vector DB? Why does the pipeline make a BLOCK decision in under 200ms? The thinking behind every architectural choice — including the ones we almost got wrong.*

> 📋 **[Docs/REQUIREMENTS.md](Docs/REQUIREMENTS.md)** — *50+ functional requirements, 20+ non-functional ones — written before a single line of code. This is what it actually takes to build a production-grade PII governance engine compliant with DPDP 2023, GDPR, and HIPAA simultaneously.*
...
<img src="Docs/open-metadata.png" alt="OpenMetadata" width="300"/>
